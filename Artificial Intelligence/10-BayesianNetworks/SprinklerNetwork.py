...
def sprinkler():
    ...
    cloudyTable = {(): (0.5, 0.5)}
    sprinklerTable = {('false',): (0.5, 0.5),
                      ('true',): (0.9, 0.1)}
    rainTable = {('false',): (0.8, 0.2),
                 ('true',): (0.2, 0.8)}
    wetgrassTable = {
        ('false', 'false'): (1, 0),
        ('true', 'false'): (0.1, 0.9),
    ...
    cloudy = Variable('Cloudy', ('false', 'true'), cloudyTable)
    sprinkler = Variable('Sprinkler', ('false', 'true'), sprinklerTable, [cloudy])
    rain = Variable('Rain', ('false', 'true'), rainTable, [cloudy])
    wetgrass = Variable('WetGrass', ('false', 'true'), wetgrassTable, [sprinkler, rain])
